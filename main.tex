...
%				\scriptsize daily, local scale, 4 bands (3m by 3m pixels)
		...
		\begin{columns}
			...
			\begin{itemize}
				...
				\item 250m by 250m pixels
				\item 39 bands
			\end{itemize}	
			\column{.33\textwidth}
			\begin{itemize}
				\item 2-5 days
				\item 10m by 10m pixels
				\item 13 bands
			\end{itemize}
			\column{.33\textwidth}
			\begin{itemize}
...
%			common remote sensing feature: $\text{NDVI} = \frac{\text{NIR} - \text{RED}}{\text{NIR} + \text{RED}}$ \\
	...
	\begin{frame}
		...
		\node(a) at (0,0){\includegraphics[width=0.9\textwidth]{images/denethor/43647_Meadows_images}};
		\node(b)[below=0em of a]{\includegraphics[width=0.9\textwidth]{images/denethor/82235_Wheat_images}};
		\visible<1>{
			\node(c)[below=of b, xshift=-4em]{\includegraphics[width=.8\textwidth]{images/denethor/plots_2018.pdf}};
		}
	
		\visible<2>{
			\node(c)[below=of b, xshift=-4em]{\includegraphics[width=.8\textwidth]{images/denethor/plotss2.pdf}};
		}
		\node(d)[right=-4em of c, yshift=1em]{\includegraphics[width=3cm]{images/denethor/map}};
