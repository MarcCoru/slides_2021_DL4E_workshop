...
%		]{\includegraphics[width=\textwidth]{mp4/apenne_modis_ndvi.png}}{mp4/apenne_modis_ndvi.mp4}
	...
	\begin{frame}{Label Data in Abundance}
		\begin{tikzpicture}
			\node{\includegraphics[width=\textwidth]{images/france_crop_distribution}};
			\visible<2>{
...
%	\end{frame}
	...
	\begin{frame}{In- and Out-of-Dist. Generalization}
		...
		\begin{tikzpicture}
			...
			\visible<3->{
				\node[fill=white, fill opacity=0.5, text opacity=1] at (b1) {\includegraphics[width=4cm]{images/francecrops/frf1_train_highlighted}};
				\node[fill=white, fill opacity=0.5, text opacity=1] at (b2) {\includegraphics[width=4cm]{images/francecrops/frf1_test_highlighted}};
			}
		\end{tikzpicture}
	\end{frame}
...
%				}
			...
			\column{.66\textwidth}
				...
				\begin{tikzpicture}
					\node[inner sep=0](a){\includegraphics[width=7cm]{maml_algs/maml_alg}};
...
%					\draw[-Stealth] (pc) -- (c.center);
	...
	\begin{frame}{Deepglobe Land Cover Classification}
		\begin{columns}
			...
			\visible<2->{\includegraphics[height=1.8cm]{deepglobe/deepglobe_results_shots_1}}
			\visible<5->{\includegraphics[height=1.8cm]{deepglobe/deepglobe_results_shots_2}}
				
			\visible<3->{\includegraphics[height=3.7cm]{deepglobe/deepglobe_results_pca_1}}
			\visible<4->{\includegraphics[height=3.7cm]{deepglobe/deepglobe_results_pca_2}}
...
%		 		\node[label={[font=\scriptsize\sffamily, yshift=-1em]above:random}, right=0em of pretrained](random){\includegraphics[width=4cm]{figures/sen12ms-2d-losses/random/0/loss_surface}};
...
%			\node(node name) {\includegraphics[width=1.3\textwidth]{epfl/tourbillon}};
			\node[text width=5cm, fill=taupe, text=white, font=\bfseries, rounded corners] at (3,-.5){
				Marc Ru\ss{}wurm \small @marccoru
				\\
				\vspace{1em} 
